		...
		return (
			<div class={style.social_footer}>
				<div class={style.social_body}>
					<p>Keep in touch with GDG Indore for the latest I/O announcements</p>
					<div>
						<a alt="" href="https://www.facebook.com/gdgindore/" target="_blank" rel="noopener noreferrer">
							<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
								<title>GDG Indore Facebook Page</title>
						...
						<a href="https://www.meetup.com/GDGIndore/" target="_blank" rel="noopener noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
								<title>GDG Cloud Indore Meetup</title>
