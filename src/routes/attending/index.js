...
export default class Attending extends Component {
	...
	componentDidMount() {
		document.title = 'Attending - I/O Extended 2019 Indore';
					...
					{showEvent &&
						<div class={style.event} id="event">
							...
							<div class={style.attending_item}>
								...
								<div class={style.attending_content}>
									<p>I/O Extended 2019 Indore features hands-on learning, Google's latest developer products, and technical talks given by the engineers who are developing our latest APIs and tools–plus a few surprises along the way.</p>
									<br />
									<p><b>Sessions</b></p>
